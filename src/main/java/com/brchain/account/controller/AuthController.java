...
public class AuthController {
	...
	public ResponseEntity<ResultDto> register(
			@ApiParam(value = "회원가입 정보 DTO", required = true) @RequestBody RegisterDto registerDto) {
	...
	public ResponseEntity<ResultDto> login(
			@ApiParam(value = "로그인 정보 DTO", required = true) @RequestBody LoginDto loginDto) {
	...
	@PostMapping("/refresh")
	public ResponseEntity<ResultDto> refreshToken(
			@ApiParam(value = "리프레시 토큰 정보 DTO", required = true) @RequestBody RefreshTokenDto refreshTokenDto) {
